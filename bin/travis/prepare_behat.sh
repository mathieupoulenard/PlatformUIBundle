...
git clone --depth 1 --single-branch --branch bazinga https://github.com/ezsystems/ezplatform.git
cd ezplatform
...
echo "> Updating packages (ezsystems/platform-ui-bundle:dev-tmp_travis_branch as 1.3)"
composer require --no-update "ezsystems/platform-ui-bundle:dev-tmp_travis_branch as 1.3"
